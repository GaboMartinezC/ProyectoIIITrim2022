...
public class VerTodoFuentePoder extends JFrame implements ActionListener
{
    JLabel jlEtiqueta;
    JTable tabla;
    JScrollPane jspContenedor = new JScrollPane();
    
    public VerTodoFuentePoder ()
    {
       try
       {
            setLayout(null);
    ...
    {
        VerTodoFuentePoder verT = new VerTodoFuentePoder();
