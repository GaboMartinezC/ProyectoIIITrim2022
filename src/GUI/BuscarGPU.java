...
public class BuscarGPU extends JFrame implements ActionListener
{
    JLabel jlEtiqueta;
    JTable tabla;
    JScrollPane jspContenedor = new JScrollPane();
    
    public BuscarGPU (String descripcion)
    {
        try
        {
            setLayout(null);
            ...
            listaGPU = bl.BuscarGPU(descripcion);
    ...
    {
        String descripcion = JOptionPane.showInputDialog("Digite la descripcion del GPU:");
        BuscarGPU busc = new BuscarGPU(descripcion);
