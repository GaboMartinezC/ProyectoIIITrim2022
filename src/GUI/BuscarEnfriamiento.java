...
public class BuscarEnfriamiento extends JFrame implements ActionListener
{
    JLabel jlEtiqueta;
    JTable tabla;
    JScrollPane jspContenedor = new JScrollPane();
    
    public BuscarEnfriamiento (String descripcion)
    {
        try
        {
            setLayout(null);
            ...
            listaEnfriamiento = bl.BuscarEnfriamiento(descripcion);
    ...
    {
        String descripcion = JOptionPane.showInputDialog("Digite la descripción del sistema de enfriamiento:");
        BuscarEnfriamiento busc = new BuscarEnfriamiento(descripcion);
